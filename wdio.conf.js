...
exports.config = {
  ...
  specs: [
    ...
    './features/feature/positive.login.scenarions.feature',
      './features/feature/negative.login.scenarios.feature',
  ],
  // Patterns to exclude.
  exclude: [
 ...
 // services: ["selenium-standalone"],
  ...
  beforeScenario: function(uri, feature, scenario, sourceLocation, context) {
    ...
    browser.addCommand("waitAndSetTextValue", function(selector, text) {
      try {
        ...
        throw new Error(
          `could not setTextValue:  ${text} in the textBox: ${selector}`
        );
      }
    });
  },
  ...
  /**
    ...
    if (error) {
      browser.saveScreenshot('./Reporters/screenShots/Browser - '+date +'.png');
    }
  },
